...
import CommercialClientsScreen from '../screens/Admin/CommercialClientsScreen';
import FinanceComptabiliteScreen from '../screens/Admin/FinanceComptabiliteScreen';
import FlotteAgricultureElevageScreen from '../screens/Admin/FlotteAgricultureElevageScreen';
import RHPersonnelScreen from '../screens/Admin/RHPersonnelScreen';
import TraceabiliteParametresScreen from '../screens/Admin/TraceabiliteParametresScreen';
...
const CustomDrawerHeader = () => (
    <View style={styles.drawerHeader}>
        <View style={styles.avatarContainer}>
            <MaterialIcons name="admin-panel-settings" size={50} color="#FFF" />
        </View>
        <Text style={styles.drawerHeaderTitle}>Administration</Text>
                ...
                return (
                    <View style={styles.drawerContainer}>
                        ...
                        <View style={styles.drawerFooter}>
                            ...
                            <Text style={styles.footerSubtext}>Module Administration</Text>
                        </View>
                    </View>
                );
            }}
