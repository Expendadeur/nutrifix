...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 05 fév. 2026 à 22:53
...
(1, 'Direction G├®n├®rale', NULL, 'rh', 100000000.00, 1, 'actif', '2026-02-02 05:44:29', '2026-02-02 05:44:29'),
(2, 'Finance & Comptabilit├®', 1, 'finance', 50000000.00, 2, 'actif', '2026-02-02 05:44:29', '2026-02-02 05:44:29'),
...
(5, '├ëlevage', 1, 'elevage', 120000000.00, NULL, 'actif', '2026-02-02 05:44:29', '2026-02-02 05:44:29'),
...
CREATE TABLE `utilisateurs` (
  ...
  `role` enum('admin','manager','employe','comptable','veterinaire','chauffeur','agriculteur','technicien') COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_departement` int NOT NULL,
  `date_embauche` date NOT NULL,
  `date_naissance` date DEFAULT NULL,
  `adresse` text COLLATE utf8mb4_unicode_ci,
